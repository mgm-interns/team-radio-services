...
public class SongControllerTest {
    ...
    public void testGetListSong() {
        ...
        when(songService.getListSongIn(STATION_ID)).thenReturn(resultSearchSong);

        //test
        webTestClient.get()
                .uri(URI.create("/api/v1/songs/sse/listSong?stationId=" + STATION_ID))
                ...
                .subscribe(data -> {
                    ...
                    if (((LinkedHashMap) responseData) != null) {
                        ...
                        //assert song 1
                        assertEquals("url1", dataMap.get(0).get("url"));
                        assertEquals("1", dataMap.get(0).get("songId"));

                        //assert song 2
                        assertEquals("url2", dataMap.get(1).get("url"));
                        assertEquals("2", dataMap.get(1).get("songId"));
                    }
                });
    }

    @Test
    public void testGetListSong_notExistStationId() {
        final String STATION_ID = "5ab0c35c04a97f2c08954fa6";

        //given this Flux SongDTO
        when(songService.getListSongIn(STATION_ID)).thenReturn(Flux.empty());
    ...
    @Test
    public void testGetAvailableListSong() {
        final String STATION_ID = "5ab0c35c04a97f2c08954fa6";
        final List<String> playListCreatorId = Arrays.asList("5ab0c35c04a97f2c08954fa6", "5ab0c2eb04a97f2c08954fa5");
        ...
        //test
        webTestClient.get()
                .uri(URI.create("/api/v1/songs/sse/listAvailableSong?stationId=" + STATION_ID))
                .header("Content-Type", MediaType.TEXT_EVENT_STREAM_VALUE)
                .exchange()
                .expectStatus()
                .isOk()
    ...
    @Test
    public void testGetAvailableListSong_notExistStationId() {
        final String STATION_ID = "5ab0c35c04a97f2c08954fa6";
